...
// #############################
  ...
  bool tracing = false;
  uint16_t secondQueuePort = 3001; //priority
  ...
  std::string filename = "-TwoQs-40.txt";
  std::string DEFAULT_DELAY = "30ms";
  std::string DEFAULT_DELAY_Q = "30ms";

  std::string S1N1Delay = DEFAULT_DELAY_Q;
  std::string S2N1Delay = DEFAULT_DELAY_Q;
  std::string N1N2Delay = DEFAULT_DELAY_Q;
  std::string N2R1Delay = DEFAULT_DELAY;
  std::string N2R2Delay = DEFAULT_DELAY;

  std::string DEFAULT_DATARATE = "4Mbps";
